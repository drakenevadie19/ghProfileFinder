...
const UserDetailsPage = () => {
    ...
    const [currentDisplaying, setCurrentDisplaying] = useState("Repo");
    ...
    return (
      <>
          ...
          <div className="user-detail-headline-wrap">
            ...
            <div className="user-detail-headline">
              ...
              <div className="user-detail-headline-image-wrap">
                <img
                  className="user-detail-headline-image"
        ...
        <div
          className="user-detail-repos-follower-following-wrap"
          id="belowDiv"
          style={{ ...belowDivStyle }}
        >
          <div className="user-detail-r-f--navbar">
            ...
            <div
              ...
              onClick={() => setCurrentDisplaying("Repo")}
            >
              <p
                className={
                  currentDisplaying === "Repo"
                    ? "user-detail-r-f--navbar-tab-name u-d-name--active "
                    : "user-detail-r-f--navbar-tab-name"
                }
              >
                Repositories
              </p>
              <p
                className={
                  currentDisplaying === "Repo"
                    ? "user-detail-r-f--navbar-tab-number u-d-number--active "
                    : "user-detail-r-f--navbar-tab-number"
                }
              >
            ...
            <div
              className="user-detail-r-f--navbar-tab"
              onClick={() => setCurrentDisplaying("Following")}
            >
              <p
                className={
...
{/* ------------- */}
            ...
            >
              ...
              <p className="user-detail-r-f--navbar-tab-number">
                <strong>{userProfile.followers}</strong>
              </p>
            </div> */}
